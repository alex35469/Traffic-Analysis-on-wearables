...
confusion_matrix(events_train, events_test_classic, show=False, output="confusion-matrix-app-LEO-BX9_open_2_"+  str(MINIMUM_PAYLOAD//1000) +"KB_" + str(int(RATIO_APP_NOT_SATIFING_MINIMUM_PAYLOAD_CUT_OFF * 100)) + "percent", adversary_capture_duration=-1)
